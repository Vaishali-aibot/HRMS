...
import { cancelWFHRequest, decideWFHRequest, type WFHActionState } from "@/lib/actions/wfh";
...
export function WFHRequestRow({
  ...
  const [cancelState, cancelAction, cancelPending] = useActionState(cancelWFHRequest, initialState);
  const [approveState, approveAction, approvePending] = useActionState(
    decideWFHRequest,
    initialState
  );
  const [rejectState, rejectAction, rejectPending] = useActionState(decideWFHRequest, initialState);
